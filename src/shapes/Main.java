...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (option == 1) {
            ...
            System.out.println ("The area of your rectangle is "+r1.getArea()+" and the perimeter is "+r1.getPerimeter());
            
        } else if (option== 2) {
            System.out.println ("what is your radius?");
            double radius = in.nextDouble();
            Circle c1 = new Circle(radius); 
        System.out.println(" The circle has a area of " + c1.getArea() + " and a circumference of " + c1.getCircumference());
        } else if (option== 3) {
            ...
            System.out.println("what is the height?");
            double Height = in.nextDouble();
            Rectangular RP1 = new Rectangular(Length,Width,Height);
            System.out.println("The rectangular pyramid has a volume of "+ RP1.getVolume()+ " and a surface area of " + RP1.getSurfaceArea());
        } else if (option==5){
            System.out.println("What is the radius?");
            double Radius = in.nextDouble();
            Sphere S1 = new Sphere(Radius);
            System.out.println("The Volume of your Sphere is "+S1.getVolume()+" and your sphere has a surface area of "+S1.getSurfaceArea());
        } else if (option==6){
            System.out.println("What is your length?");
            double Length = in.nextDouble();
            System.out.println("What is your width?");
